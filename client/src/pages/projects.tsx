          ...
          <>
            ...
            <div className="hidden md:flex flex-1 flex-col bg-background overflow-auto">
              <div className="p-6 border-b bg-muted/30">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed max-w-2xl">
                  These projects represent stepping stones in a learning journey—each one exploring different aspects of AI, automation, and connected experiences. Through building these applications, patterns emerged that eventually converged into the vision for Bilko's AI School.
                </p>
              </div>
            ...
            <div className="md:hidden flex-1 p-4 overflow-auto">
              ...
              <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
                These projects represent stepping stones in a learning journey—each one exploring AI, automation, and connected experiences. Through building them, the vision for Bilko's AI School emerged.
              </p>

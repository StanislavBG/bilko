...
**Priority:** HIGH  
**Partition:** agent  
**Dependencies:** ARCH-000, AGENT-001, AGENT-002

## Overview

This protocol defines how an AI agent should validate that the codebase correctly implements the documented rules. It complements AGENT-002 (Rule Audit) by checking code-vs-rules alignment rather than rule-vs-rule consistency.
...
|------------|-------|----------|
| Rule Audit | Rules vs Rules | AGENT-002 |
| Code Audit | Code vs Rules | AGENT-003 |

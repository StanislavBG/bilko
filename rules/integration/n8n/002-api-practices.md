...
**PRIMARY REFERENCE**: This is the comprehensive n8n integration rule. It contains all detailed practices, known issues, and directives.
...
- **Description**: n8n error responses (e.g., 404 for unregistered webhooks) use a different format than our expected AGT-003 contract. Errors were logged as generic "N8N_ERROR" / "Workflow execution failed" instead of actual n8n messages.
